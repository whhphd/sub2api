...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	turnStateHunter := service.ProvideOpenAITurnStateHunterService(openAIGatewayService, accountRepository, proxyRepository, proxyExitInfoProber, apiKeyService, leaderLockCache)
