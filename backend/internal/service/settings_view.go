...
type SystemSettings struct {
	...
	OpenAIOAuthNewAccountProxyPoolEnabled     bool   // 新建 OpenAI OAuth 账号从预选代理池随机分配代理（默认 false）
	OpenAIOAuthNewAccountProxyPoolIDs         []int64
...
func cloneOpenAIOAuthRuntimeSettings(settings *OpenAIOAuthRuntimeSettings) *OpenAIOAuthRuntimeSettings {
	if settings == nil {
