export default {
    settings: {
      ...
      openaiOauthRuntime: {
        ...
        proxyRotationEnabledHint: 'Only applies to OpenAI OAuth accounts; usage-exhaustion 429 responses do not rotate the proxy. If no replacement is available, the current proxy is kept.',
