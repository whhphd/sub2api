export default {
    settings: {
      ...
      openaiOauthRuntime: {
        injectionTitle: 'OpenAI OAuth Tool-Call Injection',
        injectionDescription: 'Control no-op exec tool-call injection for all OpenAI OAuth accounts.',
        injectionEnabled: 'Enable tool-call injection',
        injectionEnabledHint: 'Inject one fixed custom_tool_call and custom_tool_call_output pair after every user message.',
        injectionSaved: 'OpenAI OAuth tool-call injection settings saved',
        injectionSaveFailed: 'Failed to save OpenAI OAuth tool-call injection settings',
        ...
        dynamic429Title: 'OpenAI OAuth 429 Dynamic Scheduling',
        dynamic429Description: 'Treat OpenAI OAuth-like 429 responses as samples and pause scheduling based on their ratio within a window.',
        dynamic429Enabled: 'Enable dynamic scheduling',
        dynamic429EnabledHint: 'Start collecting 429 and success/other-error samples after the first 429, then use the shared rate-limit state once the thresholds are met.',
        windowSeconds: 'Statistics window (seconds)',
        windowSecondsHint: 'Window duration counted from the first 429 (60–3600 seconds)',
        minimumSamples: 'Minimum samples',
        minimumSamplesHint: 'Wait for this many samples before evaluating the ratio (2–10000)',
        minimum429Count: 'Minimum 429 count',
        minimum429CountHint: 'At least this many 429 responses are required before pausing (1–minimum samples)',
        ratioThreshold: '429 ratio threshold',
        ratioThresholdHint: '429 responses divided by all samples in the window, from 0.01 to 1',
        pauseMode: 'Pause duration',
        pauseModeUpstreamReset: 'Use existing pause-duration logic',
        pauseModeUpstreamResetHint: 'Prefer the upstream quota reset time, then use the system 429 default cooldown setting.',
        pauseModeFixed: 'Fixed duration',
        fixedPauseSeconds: 'Fixed pause duration (seconds)',
        fixedPauseSecondsHint: 'Pause scheduling for this duration after reaching the thresholds (1–7200 seconds)',
        dynamic429Saved: 'OpenAI OAuth 429 dynamic scheduling settings saved',
        dynamic429SaveFailed: 'Failed to save OpenAI OAuth 429 dynamic scheduling settings'
      },
      streamTimeout: {
