...
"turnStateHint": "Applies globally to OpenAI OAuth HTTP/SSE. Collects candidates from natural responses and hunter probes; hunted models inject a live matching candidate whenever one is available, while other models wait for a non-baseline session shape. Exhaustion does not stop scheduling. WebSockets remain unchanged; decisions have independent logs. Experimental; quality improvement is not guaranteed.",
